...
public class AdminServiceImpl implements AdminService{
	...
	@Override
	public void updatesubmissionstatus(int id, String status) {
		WorkSubmition workSubmition=workSubmitionRepository.findById(id).get();
		workSubmition.setSubmissionstatus(status);
